...
$MAX_ITEM_ROW_SMALL = $categoryConfig['listing_products_columns_small']?$themeConfig['listing_products_columns_small']:3;
...
<?php if( $SPAN[2] ): ?>
	<aside class="col-lg-<?php echo $SPAN[2];?> col-lg-<?php echo $SPAN[2];?> col-sm-12 col-xs-12">
