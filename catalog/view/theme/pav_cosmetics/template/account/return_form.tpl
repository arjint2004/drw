  ...
  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
    ...
    <div class="content">
      ...
      <div class="right"><span class="required">*</span> <?php echo $entry_order_id; ?><br />
        <input type="text" name="order_id" value="<?php echo $order_id; ?>" class="form-control large-field" />
        <br />
        ...
        <input type="text" name="date_ordered" value="<?php echo $date_ordered; ?>" class="form-control large-field date" />
        <br />
      </div>
    </div>
