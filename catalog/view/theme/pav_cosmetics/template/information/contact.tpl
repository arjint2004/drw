  ...
  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
    ...
    <h2><?php echo $text_location; ?></h2>
      <div class="contact-address">
        <p><?php echo $store; ?></p>
		<ul><li><i class="icon icon-map-marker"></i><span><b><?php echo $text_address; ?></b><br />
        <?php echo $address; ?></span></li>
        <?php if ($telephone) { ?>
        <li><i class="icon icon-phone"></i><span><b><?php echo $text_telephone; ?></b><br />
        <?php echo $telephone; ?></span></li>
        <?php } ?>
        <?php if ($fax) { ?>
        <li><i class="icon icon-hdd-o"></i><span><b><?php echo $text_fax; ?></b><br />
