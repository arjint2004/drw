...
fbq('init', '1693988334176711');
fbq('track', "PageView");
fbq('track', 'ViewContent');
</script>
<noscript><img height="1" width="1" style="display:none"
src="https://www.facebook.com/tr?id=1693988334176711&ev=PageView&noscript=1"
/></noscript>
    ...
    <section id="header">
		<section id="topbar">
			<div class="container">
                <div class="topbar">
                    <div class="row">
                        <div class="col-lg-3 col-md-3 hidden-sm hidden-xs header-right">
                        ...
                        <div class="col-lg-9 col-md-9 col-sm-6 col-xs-12 hidden-xs hidden-sm header-left">
                            ...
                            <ul class="hidden-sm hidden-xs links pull-right">
                                ...
                                <li><a class="wishlist wishlist-total" href="<?php echo $wishlist; ?>"><span class="icon-heart"></span><?php echo $text_wishlist; ?></a></li>
                        ...
                        <div class="show-mobile hidden-lg hidden-md pull-right">
                            ...
                            <div class="quick-access pull-left">
                                ...
                                <div class="inner-toggle">
                                    <ul class="links pull-left">
                                        <li><a href="<?php echo $wishlist; ?>" class="wishlist-total"><span class="icon-heart"></span><?php echo $text_wishlist; ?></a></li>
                                        <li><a class="account" href="<?php echo $account; ?>"><span class="icon-user"></span><?php echo $text_account; ?></a></li>
                                        <li><a class="shoppingcart" href="<?php echo $shopping_cart; ?>"><span class="icon-shopping-cart"></span><?php echo $text_shopping_cart; ?></a></li>
                                        <li><a class="last checkout" href="<?php echo $checkout; ?>"><span class="icon-file"></span><?php echo $text_checkout; ?></a></li>
                                    </ul>
                            ...
                            <div id="search-mobile" class="search pull-left">
                                <div class="quickaccess-toggle">
        ...
        <section id="pav-mainnav" class="">
	        <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-12 col-sm-12 col-xs-12 inner">
                        <?php if ($logo) { ?>
                    ...
                    <div class="header-right pull-right wrap-cart hidden-sm hidden-xs col-lg-2 col-md-2">
                        <div class="cart-top">
                            <?php echo $cart; ?>
                        </div>
                    </div>
