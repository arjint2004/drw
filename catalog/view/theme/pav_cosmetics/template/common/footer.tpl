		...
		<div class="container">
			<div class="row">
				...
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
					<div class="box box-blog clearfix">
				...
				<div class="column col-xs-12 col-sm-4 col-md-2 col-lg-2">
					<div class="box">
						...
						<ul class="list">
						  <li><a href="<?php echo $contact; ?>">&rarr;&nbsp;&nbsp;<?php echo $text_contact; ?></a></li>
						  <li><a href="<?php echo $return; ?>">&rarr;&nbsp;&nbsp;<?php echo $text_return; ?></a></li>
						  <li><a href="<?php echo $sitemap; ?>">&rarr;&nbsp;&nbsp;<?php echo $text_sitemap; ?></a></li>
						   <li><a href="<?php echo $manufacturer; ?>">&rarr;&nbsp;&nbsp;<?php echo $text_manufacturer; ?></a></li>
						  <li><a href="<?php echo $voucher; ?>">&rarr;&nbsp;&nbsp;<?php echo $text_voucher; ?></a></li>
                            <li><a href="<?php echo $affiliate; ?>">&rarr;&nbsp;&nbsp;<?php echo $text_affiliate; ?></a></li>
						</ul>
					</div>
				</div>
				...
				<div class="column col-xs-12 col-sm-4 col-md-2 col-lg-2">
					<div class="box">
						...
						<ul class="list">
						  <li><a href="<?php echo $account; ?>">&rarr;&nbsp;&nbsp;<?php echo $text_account; ?></a></li>
						  <li><a href="<?php echo $order; ?>">&rarr;&nbsp;&nbsp;<?php echo $text_order; ?></a></li>
						  <li><a href="<?php echo $wishlist; ?>">&rarr;&nbsp;&nbsp;<?php echo $text_wishlist; ?></a></li>
						  <li><a href="<?php echo $newsletter; ?>">&rarr;&nbsp;&nbsp;<?php echo $text_newsletter; ?></a></li>
						  <li><a href="<?php echo $special; ?>">&rarr;&nbsp;&nbsp;<?php echo $text_special; ?></a></li>
						</ul>
					</div>
				</div>
...
_Hasync.push(['Histats.start', '1,3315515,4,0,0,0,00010000']);
...
<noscript><a href="/" target="_blank"><img  src="//sstatic1.histats.com/0.gif?3315515&101" alt="free web tracker" border="0"></a></noscript>
<!-- Histats.com  END  -->
</body></html>